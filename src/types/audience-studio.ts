...
export const mockWarehouseTables = [
  ...
  },
  {
    name: "accounts",
    columns: [
      { name: "account_id", type: "uuid", isPrimaryKey: true },
  ...
  },
  {
    name: "leads",
    columns: [
      { name: "lead_id", type: "uuid", isPrimaryKey: true },
      { name: "email", type: "varchar" },
  ...
  },
  {
    name: "subscriptions",
    columns: [
      { name: "subscription_id", type: "uuid", isPrimaryKey: true },
      { name: "account_id", type: "uuid", isForeignKey: true },
  ...
  },
  {
    ...
    columns: [
      { name: "ticket_id", type: "uuid", isPrimaryKey: true },
      { name: "account_id", type: "uuid", isForeignKey: true },
